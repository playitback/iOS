...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    self.editingFileName = [NSString stringWithFormat:@"%li.png", (long)indexPath.row];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *fileNameString = [NSString stringWithFormat:@"%li.png", (long)indexPath.row];
...
{
    // Since the reference used for the observer block is weak, check first
    // to make sure the file is still in use, before using it.
    if (!file || ![self.contents.allValues containsObject:file] || ![file isOpen]) {
        return;
    }
